...
unsigned int nModifierInterval = 5 * 30; // time to elapse before new modifier is computed
...
const string strMessageMagic = "CraigsCoin Signed Message:\n";
...
bool CTransaction::CheckTransaction() const
{
    ...
    if (hasMsg && !foundMsgFee)
    {
      return DoS(100, error("CTransaction::CheckTransaction() : invalid AD fee for %s",
...
static const int64_t nTargetTimespan = 2 * 30;  // 2 mins
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CraigsCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "The simplest environment will be, perhaps, a very basic text editor (e.g., ed) and an assembler program.";
        CTransaction txNew;
        txNew.nTime = 1412185091;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("a6c3eea8b16bc916fd1b19d14d81f844a4ac6dddf2667759a2feef257992fdc6"));
        block.print();
